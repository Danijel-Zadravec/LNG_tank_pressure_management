# -*- coding: utf-8 -*-
"""
Created on Mon May 16 22:09:15 2022
...
from src.System_Compressor_single import SystemLNG_Compressor
...
def create_system_Compressor(slosh_times, evap_flow, super_flow, comp_flow):
    ...
    stsC = CompressorStates(T_in0, 0.0, p_in0, p_out0)
    compressor = Compressor(eta, stsC)
    ...
    systemPump = SystemLNG_Compressor(tank, lng_pump, thr_val, pipe_pmp, evaporator, compressor, mixer, evap_pipe, he_superheater, engine_pipe, evap_flow, super_flow, comp_flow)
    return systemPump
