...
from src.System_Pump_single import SystemLNG_Pump
...
def create_system_Pump(slosh_times, evap_flow, super_flow):
    ...
    systemPump = SystemLNG_Pump(tank, lng_pump, thr_val, pipe_pmp, evaporator, valve, evap_pipe, he_superheater, engine_pipe, evap_flow, super_flow)
    return systemPump
