# -*- coding: utf-8 -*-
"""
One-at-a-time (OAT) sensitivity analysis for the Compressor dual-fuel FGSS.

Base case: scripts/analysis/Compressor_dual.py
...
fuel, and mechanical (pump + compressor) energy. Saves a long-form CSV and a
publication-style tornado diagram (one panel per metric).
