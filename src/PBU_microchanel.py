...
class PBUStates():
    def __init__(self, evap_lng, evap_glyc):
        self.evap_lng = evap_lng
        self.evap_glyc = evap_glyc
        self.evap_com =  CommonStatesPBU()
...
class PBU():
    def __init__(self,params, states):
        self.params = params
        self.states = states
        self.save = SavePBU(self.states) #inicijalizacija spremanja rezultata
        self.save.save_states(self.states) #spremanje pocetnih stanja

    def calc_glyc_states(self):
    ...
    def calc_evap_alfa_lng(self):
        ...
        while abs(alfa-alfa_prev) > 1.0:
            ...
            A_wall =  (A_prim*W*L_tot + A_sec*eta*W*L_tot)
            q = Fi / A_wall
    ...
    def ne_radi(self):
        self.states.evap_lng.T_in = -1.0
        self.states.evap_lng.p = 0.0
        self.states.evap_lng.H_molar_in =0.0
        self.states.evap_lng.T_sat = 0.0
        self.states.evap_lng.H_molar_out = 0.0
        self.states.evap_lng.mol_flow = 0.0
        self.states.evap_lng.mas_flow = 0.0
        self.states.evap_lng.Tm = 0.0
        self.states.evap_lng.ro = 0.0
        self.states.evap_lng.vis_dyn = 0.0
        self.states.evap_lng.vis_cin = 0.0
        self.states.evap_lng.l = 0.0
        self.states.evap_lng.cp = 0.0
        self.states.evap_lng.Re = 0.0
        self.states.evap_lng.Nu = 0.0
        self.states.evap_lng.alfaLiq = 0.0

        self.states.evap_lng.hLV = 0.0 #toplina isparivanja
        self.states.evap_lng.G = 0.0 #gustoca masenog protoka, kg/m2s
        self.states.evap_lng.q = 0.0#
        self.states.evap_lng.Bo = 0.0 #Boiling number
        self.states.evap_lng.alfa = 0.0

        self.states.evap_glyc.T_in = 0.0
        self.states.evap_glyc.T_out = 0.0
        self.states.evap_glyc.mas_flow = 0.0
        self.states.evap_glyc.Tm = 0.0

        self.states.evap_glyc.ro = 0.0 #kg/m3
        self.states.evap_glyc.vis_dyn = 0.0
        self.states.evap_glyc.vis_cin = 0.0
        self.states.evap_glyc.l = 0.0
        self.states.evap_glyc.Re = 0.0
        self.states.evap_glyc.Nu = 0.0
        self.states.evap_glyc.alfa = 0.0

        self.states.evap_com.k = 0.0
        self.states.evap_com.heat_flow = 0.0
        self.states.evap_com.LMTD = 0.0
        self.states.evap_com.heat_flow_LMTD = 0.0
        self.save.save_states(self.states) #spremanje pocetnih stanja
